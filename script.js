...
const onResize = () => {
  // Obtiene las propiedades del tamaño de carrossel
...
const initEvents = () => {
  ...
  const autoRotate = () => {
    moveTo += 3; // Incrementa el ángulo para el movimiento automático
  };

  setInterval(autoRotate, 100); // Cambia la posición cada 3 segundos
};
